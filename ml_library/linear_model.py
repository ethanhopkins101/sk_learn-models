...
class LocallyWeightedRegression:
    ...
    def __init__(self, tunning_parameter,fit_intercept: bool= False):
...
class PoissonRegression:
    ...
    def __init__(self, fit_intercept: bool= False, learning_rate:float= 0.005,
                 exit_point: float= np.power(10.0,-5)):
        self.learning_rate: float= learning_rate
        self.parameters: Optional[np.ndarray]= None
        self.fit_intercept: bool= fit_intercept #Intercept vector check
        self.exit_point: float= exit_point

    def fit(self, x_train: MatrixLike | ArrayLike,
            y_train: MatrixLike | ArrayLike):
    ...
    def predict(self, x_test: MatrixLike | ArrayLike):
    ...
    @property
    def coef(self) -> float|np.ndarray:
        return self.parameters[1:]
    @property
    def intercept_(self) -> float:
        return self.parameters[0]